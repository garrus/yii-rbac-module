...
return array(
    ...
    "View AuthItem" => "浏览授权项",
    "Assign Operations to Tasks" => "分配操作给任务",
    "Task" => "任务",
    "Assign Roles to Users" => "分配角色给用户",
    "User" => "用户",
    "Assign Tasks to Roles" => "分配任务给角色",
    "Role" => "角色",
    ...
    "User's assignments" => "已分配的授权项",
    "Srbac frontpage" => "srbac首页",
	'Clear obsolete authItems' => '清除废弃的授权项',
	'No authItems that don\'t belong to a controller were found' => '没有废弃的授权项（所有授权项都属于某个控制器）',
	'The following items doesn\'t seem to belong to a controller' => '这些授权项似乎不属于任何一个控制器',
	'authItems removed' => '授权项已被删除',
	'User Management' => '管理用户',
	'Assignments of user' => '以下授权项已分配给用户',
	'select user' => '选择一个用户',
	'AlwaysAllowed' => '总是允许的',
