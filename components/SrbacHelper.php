...
class SrbacHelper {
	 ...
	 * @return array
	 */
	public static function firstModelError(CModel $model, $attribute=null){
...
//      $len = strlen($cleverName);
     ...
     * @param CModule $parent $parent The parent module
     * @param String $moduleID The module to find
     * @return CModule|null The module, if it's not found returns null
     */
